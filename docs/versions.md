...
Проверено 21.09.2026 по официальной документации, npm registry и файлам релиза. На этапе 2 дополнительно прошли установка, проверка типов, сборка и SSR Astro на Node 24.21.0. Runtime-проверка Directus/PostgreSQL пока не проводилась.
