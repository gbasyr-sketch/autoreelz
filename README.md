...
Домен: autoreelz.ru. Выбрано направление A. Этап 4 завершён: Astro SSR, PostgreSQL и светлая Directus CMS в отдельной Docker-среде; серверная корзина, заказы, склад, тестовая оплата и кабинет с email-кодом.
